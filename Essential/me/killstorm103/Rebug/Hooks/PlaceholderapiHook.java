	...
	public @Nullable String onRequest(OfflinePlayer offlineplayer, @NotNull String params) 
	{
		if (offlineplayer != null && offlineplayer.isOnline()) 
		{
			...
			if (params.equalsIgnoreCase("plugin"))
				return ChatColor.DARK_RED + ChatColor.BOLD.toString() + "REBUG " + ChatColor.RESET + ChatColor.BOLD + "v" + RebugPlugin.getPluginVersion();
			...
			if (params.equalsIgnoreCase("clientversion") || params.equalsIgnoreCase("client_version"))
				return PT.getVersion(player) + "";
			
			if (params.equalsIgnoreCase("clientprotocol") || params.equalsIgnoreCase("client_protocol"))
				return PT.getProtocolVersion(player) + "";
			
			if (params.equalsIgnoreCase("client") || params.equalsIgnoreCase("clientinfo") || params.equalsIgnoreCase("client_info"))
				return PT.getVersion(player) + " " + ChatColor.DARK_GRAY + "(" + ChatColor.WHITE + PT.getProtocolVersion(player) + ChatColor.DARK_GRAY + ")" + ChatColor.RESET;
			...
			if (params.equalsIgnoreCase("anticheat")) 
			{
				...
				if (FileUtils.getLoadedAntiCheatsFile().get("loaded-anticheats." + strip + ".has-short-name") != null && FileUtils.getLoadedAntiCheatsFile().get("loaded-anticheats." + strip + ".short-name") != null && FileUtils.getLoadedAntiCheatsFile().getBoolean("loaded-anticheats." + strip + ".has-short-name"))
