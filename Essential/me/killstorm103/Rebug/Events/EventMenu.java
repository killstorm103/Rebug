...
public class EventMenu implements Listener
{
	...
	private String ListedMenuNames (User user, Inventory inventory)
	{
		...
		return inventory.equals(ItemsAndMenusUtils.getINSTANCE().getAntiCheats()) ? "AntiCheats" : inventory.equals(ItemsAndMenusUtils.getINSTANCE().getRebugSettings()) ? "Rebug Settings" : null;
	}
	...
	public void onMenu (InventoryClickEvent e) 
	{
		...
		try
		{
			...
			if (MenuName.equalsIgnoreCase("Client Command Checker"))
			{
				user.sendMessage("GG");
			}
