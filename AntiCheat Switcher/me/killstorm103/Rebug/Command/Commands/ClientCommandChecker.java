...
public class ClientCommandChecker extends Command
{
	...
	public @NotNull String getUsage() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("command.commands." + getName().toLowerCase() + ".usage", "clientcommandchecker check | clientcommandchecker <getprefix or setprefix <prefix>> | clientcommandchecker <player> (console only!)");
	}

	@Override
	public @NotNull String getDescription() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("command.commands." + getName().toLowerCase() + ".description", "runs the client command checker on the player!");
	}

	@Override
	public @NotNull String getPermission() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("command.commands." + getName().toLowerCase() + ".permission", StartOfPermission + "clientcommandchecker");
	}
