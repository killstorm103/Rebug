...
public class QuickConfig 
{
	...
	public static final String ScoreboardTitle() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("scoreboard.title", "&7| &l&7killstorm103''s&r &7|");
	}
	public static final String TabScoreboardTitle() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("tab.title", "&8| &l&7killstorm103''s&r &8| &cTest &2Server &8|");
	}
	public static final String DiscordInviteLink() {
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("discord.link", "https://discord.gg/5xWHx3MUUr");
	}
	public static final String MainLabel ()
	{
		return RebugsAntiCheatSwitcherPlugin.getINSTANCE().getConfig().getString("command.settings.main-command.label", "rebugsanticheatswitcher");
	}
}
