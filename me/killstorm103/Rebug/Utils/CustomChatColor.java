...
public enum CustomChatColor
{
	...
	private final static Map<Integer, CustomChatColor> BY_ID = Maps.newHashMap();
	private final static Map<Character, CustomChatColor> BY_CHAR = Maps.newHashMap();

	private CustomChatColor(char code, int intCode) {
		this(code, intCode, false);
	}

	private CustomChatColor(char code, int intCode, boolean isFormat) {
		this.code = code;
	 ...
	 *         if it doesn't exist
	 */
	public static CustomChatColor getByChar(char code) {
	 ...
	 *         if it doesn't exist
	 */
	public static CustomChatColor getByChar(String code) 
	{
	...
	public static String translateAlternateColorCodes (char altColorChar, String textToTranslate, boolean ACInComing, String ItemName) 
	{
		try
		{
			...
			for (int i = 0; i < b.length - 1; i++)
			{
				...
				{
					b[i] = CustomChatColor.COLOR_CHAR;
	...
	public static String getLastColors(String input) {
		...
		for (int index = length - 1; index > -1; index--) {
			...
			if (section == COLOR_CHAR && index < length - 1) {
				...
				CustomChatColor color = getByChar(c);
	...
	static {
		for (CustomChatColor color : values()) {
