package me.killstorm103.Rebug.Shared.Command.Commands.ShortCut;
...
public class ShortCutBasic implements TabExecutor {
	...
	public List<String> onTabComplete(CommandSender sender, Command command, String arg2, String[] args) {
		me.killstorm103.Rebug.Shared.Command.Command c = Rebug.getINSTANCE().getCommandByName(command.getName());
		if (c != null)
			return c.HasCustomTabComplete(sender, command, args, arg2) ? c.onTabComplete(sender, command, args, arg2)
					: null;

		for (me.killstorm103.Rebug.Shared.Command.Command cmd : Rebug.getINSTANCE().getCommands()) {
